...
class DataSequenceImageCommentsMeta(Sequence):
    ...
    def __init__(self, df, pathToImages, text_list, batch_size, image_size, meansOfDataset):
        ...
        self.meansOfDataset = np.array(meansOfDataset)
        self.on_epoch_end()
    ...
    def __getitem__(self, index):
        ...
        # Generate data
        image_x, text_x, meta_x, global_y = self.__data_generation(df_batch, batch_indices)

        return [[image_x, text_x, meta_x]], global_y
